  ...
  return (
    <div className='w-11/12 max-w-3x1 text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      className='flex items-end gap-2 text-x1 md:text-2x1 mb-3 font-Ovo'>
        Hi! I'm Sanket Singh <Image src={assets.hand_icon} alt='' className='w-6'/>
      </motion.h3>
    <motion.h1
    ...
    className='text-3x1 sm:text-6x1 lg:text-[66px] font-Ovo'>
      full stack developer based in Raipur.</motion.h1>
      ...
      className='max-w-2x1 mx-auto font-Ovo'>
        I am a full stack developer from Raipur, Chhattisgarh India. A fresher looking for great opportunities to build and work with new techologies.
      </motion.p>
