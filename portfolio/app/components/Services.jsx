  ...
  return (
    ...
    id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        className='text-center max-w-2x1 mx-auto mt-5 mb-12 font-Ovo'>
           I am fresher computer science graduate looking for opportunities to showcase my skills and build beautiful web applications 
           I have knowledge of Javascript . I use React , Next js and Tailwind CSS. </motion.p>  
