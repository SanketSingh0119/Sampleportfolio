        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            ...
            className='flex-1'>
                <p className='mb-10 max-w-2x1 font-ovo'>
                    I am an full stack developer fresher and computer science graduate .
                    skilled in frontend and backend both.I am skilled in MERN stack
                    technology . I know React and different frameworks which i use .
                </p>
                ...
                className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2x1'>
                    {infoList.map(({icon, iconDark, title, description},index)=>(
                        ...
                        className='border-[0.5px] border-gray-400 rounded-x1 p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white 
